                ...
                <form method="post" action="#">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-lg-6">
                                <label for="address_country2">Country <span class="required-f">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-lg-6">
                                <label for="address_province">City <span class="required-f">*</span></label>
                ...
                <div class="your-payment">
                    ...
                    <div class="payment-method">
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item card mb-2">
                                    <div class="card-header" id="headingOne">
                                        <button class="card-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Direct Bank Transfer</button>
                                    </div>
                                ...
                                <div class="accordion-item card mb-2">
                                    <div class="card-header" id="headingThree">
                                        <button class="card-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">PayPal</button>
                                    </div>
                                ...
                                <div class="accordion-item card mb-2">
                                    <div class="card-header" id="headingFour">
                                        <button class="card-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Payment Information</button>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 col-lg-6">
                                                        <label>Credit Card Type <span class="required-f">*</span></label>
                        ...
                        <div class="order-button-payment mt-3 clearfix">
                            <a href="checkout-success.html" class="fs-6 btn btn-lg rounded w-100 fw-600 text-white">Place order</a>
                        </div>
                    </div>
                </div>
            </div>
